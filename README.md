...
| ページ | URL |
|--------|-----|
| 値上がりカード | `/ja/price_movers` / `/ja/price_movers/{period}` |
| YouTube動画 | `/ja/videos` |
| このサイトについて | `/ja/about` |
| お問い合わせ | `/ja/contact` |
...
```
https://mtg.syowa.workers.dev/             ← /ja へリダイレクト
https://mtg.syowa.workers.dev/ja/          ← トップ（1995〜2003）
https://mtg.syowa.workers.dev/ja/{format}  ← 各フォーマット
https://mtg.syowa.workers.dev/ja/price_movers
https://mtg.syowa.workers.dev/ja/price_movers/{period}
https://mtg.syowa.workers.dev/ja/videos
https://mtg.syowa.workers.dev/ja/about
https://mtg.syowa.workers.dev/ja/contact
https://mtg.syowa.workers.dev/ja/privacy
```
...
- [@astrojs/cloudflare](https://docs.astro.build/ja/guides/integrations-guide/cloudflare/) — Cloudflare Workers へのデプロイ
